...
class Slider{
  constructor(selector){
    ...
    this.f1 = this.gui.addFolder('bubble');
    this.f1.add(this.settings,'mRefractionRatio',0,1,0.001).onChange(bind(function(value) {
      this.core.material.uniforms.mRefractionRatio.value = value;
     // console.log(this);
     },this));
     this.f1.add(this.settings,'mFresnelBias',0,1,0.001).onChange(bind(function(value) {
      this.core.material.uniforms.mFresnelBias.value = value;
     // console.log(this);
     },this));
     this.f1.add(this.settings,'mFresnelPower',0,5,0.001).onChange(bind(function(value) {
      this.core.material.uniforms.mFresnelPower.value = value;
     // console.log(this);
     },this));
     this.f1.add(this.settings,'mFresnelScale',0,1,0.001).onChange(bind(function(value) {
      this.core.material.uniforms.mFresnelScale.value = value;
     // console.log(this);
     },this));
  ...
  this.material.envMap.mapping = THREE.CubeReflectionMapping;
	...
	this.customMaterial = new THREE.ShaderMaterial( 
	{
        ...
        "uWiggleDisplacement": { type: 'f', value: 0.01 },
        "uWiggleSpeed": { type: 'f', value: 0.03 },
        "tCube": 			{ type: "t", value: this.refractSphereCamera.renderTarget.texture } //  textureCube }
      },
   ...
   // this.bigtestgeometry.scale(  -1, 1, 1 );
    ...
    this.core.scale.x=this.core.scale.y=this.core.scale.z=1.2;
